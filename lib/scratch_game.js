...
class ScratchGame {
    ...
    createText(text, x, y) {
        return new ScratchText(this, text, x, y);
    }
...
class ScratchSprite {
    ...
    onOverlap(sprite2, func) {
        this.#createdGame.physics.add.overlap(this.#sprite, sprite2.#sprite, func, this.#checkPixelPerfect, this);
    }

    #checkPixelPerfect(obj1, obj2) {
        ...
        for (let y = intersection.y; y < intersection.bottom; y++) {
            for (let x = intersection.x; x < intersection.right; x++) {
